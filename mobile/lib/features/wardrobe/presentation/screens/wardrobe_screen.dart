...
class WardrobeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WardrobeScreen> createState() =>
      _WardrobeScreenState();
}

class _WardrobeScreenState
    extends ConsumerState<WardrobeScreen> {
  String _filter = 'All';
  ...
  void initState() {
    ...
    Future.microtask(
      () => ref
          .read(
            wardrobeControllerProvider.notifier,
          )
  ...
  Future<void> _deleteItem(
    ...
    final confirmed =
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'Remove "${item.name}" from this wardrobe?',
        ),
        actions: [
          TextButton(
            onPressed: () =>
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              // HERO
              //
              // The 10px horizontal SliverPadding is intentional.
              // It gives the wardrobe hero the same breathing room as
              // the Home screen instead of letting it touch the corners.
              // ---------------------------------------------------------------
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Add your first piece and start building looks that feel like you.',
              textAlign:
                  TextAlign.center,
