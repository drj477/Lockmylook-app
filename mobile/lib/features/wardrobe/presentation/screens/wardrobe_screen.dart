...
class _WardrobeScreenState extends ConsumerState<WardrobeScreen> {
  ...
  Future<void> _toggleFavorite(WardrobeItem item) => ref
      .read(wardrobeControllerProvider.notifier)
  ...
  Widget build(BuildContext context) {
    ...
    final filtered = state.items.where((item) {
      ...
      final matchesFilter =
          _filter == 'All' ||
          item.category.name.toLowerCase() == _filter.toLowerCase();
  ...
  Widget _header() {
    return Row(
      children: [
        ...
        IconButton(
          onPressed: _openAddItem,
          icon: const Icon(Icons.add, color: LockMyLookUi.ink),
        ),
      ],
    );
  }
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, index) {
          ...
          return GestureDetector(
            ...
            child: LockMyLookUi.pill(category, selected: _filter == category),
          );
        },
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Add your first item and start building looks.',
