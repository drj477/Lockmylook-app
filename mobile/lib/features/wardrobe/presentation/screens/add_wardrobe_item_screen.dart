        ...
        child: Column(
          children: [
            Container(
              ...
              child: const Icon(Icons.camera_alt_outlined, color: LockMyLookUi.coral),
            ),
  ...
  InputDecoration _fieldDecoration({
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(16),
        borderSide: const BorderSide(color: LockMyLookUi.coral, width: 1.5),
      ),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(Icons.arrow_back_rounded, color: LockMyLookUi.ink),
        ),
        title: const Text(
          'Add Wardrobe Item',
          style: TextStyle(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFFFFF1EF), Color(0xFFF4F2FF)],
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 3),
                Text(
                  'Add one piece and let LockMyLook make it style-ready.',
                  style: TextStyle(
  ...
  Widget _sectionHeader(String title, String subtitle) {
    return Column(
      ...
      children: [
        ...
        Text(
          subtitle,
          style: const TextStyle(color: LockMyLookUi.muted, fontSize: 12),
        ),
      ],
    );
  }
                    ...
                    Positioned(
                      ...
                      child: Material(
                        ...
                        child: IconButton(
                          ...
                          icon: const Icon(Icons.close, color: LockMyLookUi.ink),
  ...
  Widget _saveButton(bool creating) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: LockMyLookUi.coral.withValues(alpha: 0.25),
            blurRadius: 16,
      ...
      child: SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          label: Text(
            creating ? 'Adding to wardrobe...' : 'Add to Wardrobe',
