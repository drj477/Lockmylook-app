...
class SecureStorage {
  ...
  Future<void> saveTodayPick({
    ...
    await Future.wait([
      ...
      _storage.write(key: _todayPickIdsKey, value: itemIds.join(',')),
      _storage.write(key: _todayPickSeedKey, value: seed.toString()),
    ]);
  }
  ...
  Future<Map<String, dynamic>?> getTodayPick() async {
    ...
    return {
      'date': date,
      'itemIds': ids.split(',').where((id) => id.isNotEmpty).toList(),
